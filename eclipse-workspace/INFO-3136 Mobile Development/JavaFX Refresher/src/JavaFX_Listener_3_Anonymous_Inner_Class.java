/**
 * Program Name: JavaFX_Listener_3_Anonymous_Inner_Class.java <br>
 * Purpose: shows using ANONYMOUSE INNER CLASSES as the listener for a button push event.
 * Coder: Bill Pulling
 * Date: July 8, 2025
 */
...
public class JavaFX_Listener_3_Anonymous_Inner_Class extends Application
{
  //CLASS WIDE SCOPE AREA
	...
	public void start(Stage myStage) throws Exception
	{
		...
		addBtn = new Button();
		addBtn.setText("Add");
		//handle the event using an ANONYMOUS INNER CLASS
		addBtn.setOnAction(new EventHandler<ActionEvent>() 
			...
			);//closing parenthesis for the setOnAction() method 
		
	  //repeat for the second button	
		subtractBtn = new Button("Subtract");
		subtractBtn.setOnAction(new EventHandler<ActionEvent>()  
			{
			  //handle the event here
			  public void handle(ActionEvent ev)
			  {
		...
		myStage.setTitle("Using ANONYMOUS INNER CLASSES as Listeners for Button Events");
