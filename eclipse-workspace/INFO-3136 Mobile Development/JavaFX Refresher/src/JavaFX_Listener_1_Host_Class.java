/**
 * Program Name: JavaFX_Listener_1_Host_Class.java <br>
 * Purpose: shows using the HOST CLASS object as the listener for a button push event.
 * Coder: Bill Pulling
 * Date: July 8, 2025
 */
...
public class JavaFX_Listener_1_Host_Class extends Application implements EventHandler<ActionEvent>
{
  //CLASS WIDE SCOPE AREA
	...
	public void start(Stage myStage) throws Exception
	{
		...
		addBtn = new Button();
		addBtn.setText("Add");
		//register the host class as a listener for this button
		addBtn.setOnAction(this); //in swing we use addActionListener()
		
		subtractBtn = new Button("Subtract");
		subtractBtn.setOnAction(this);
		...
		myStage.setTitle("Using Host as Listener for Button Events");
