 ...
 * Purpose: first version that shows use of LAMBDA EXPRESSIONS to handle a button push event.
 * Coder: Bill Pulling
 * Date: July 8, 2025
 */
...
public class JavaFX_Listener_4_Lambda_Expression_1 extends Application
{
  //CLASS WIDE SCOPE AREA
	...
	public void start(Stage myStage) throws Exception
	{
		...
		//REVISION HERE: use a LAMBDA EXPRESSION as the event handler
	  ...
	  //repeat for the second button	
		...
		myStage.setTitle("Using LAMBDA EXPRESSIONS to handle Button Events");
