 ...
 * Purpose:provides a static method that will	convert a ResultSet object passed in from a query
 *         into a TableModel object, which can then be used to create, which is then used to
 *         create a JTable for displaying the data.
