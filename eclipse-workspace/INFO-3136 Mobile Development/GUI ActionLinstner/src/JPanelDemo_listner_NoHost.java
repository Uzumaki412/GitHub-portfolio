...
public class JPanelDemo_listner_NoHost extends JFrame {

	public JPanelDemo_listner_NoHost() {
		super("JButton listner with no host"); // title
		...
		ButtonListener buttonListener = new ButtonListener(); // Create an instance of the inner class ButtonListener
		
		redBtn.addActionListener(buttonListener);
		greenBtn.addActionListener(buttonListener);
		blueBtn.addActionListener(buttonListener);
		yellowBtn.addActionListener(buttonListener);
		blackBtn.addActionListener(buttonListener);
		greyBtn.addActionListener(buttonListener);
	...
	public static void main(String[] args) {
		JPanelDemo_listner_NoHost frame = new JPanelDemo_listner_NoHost();
	}//end main
	
	private class ButtonListener implements ActionListener {
		@Override
		public void actionPerformed(ActionEvent ev) {
			Container contentPane = JPanelDemo_listner_NoHost.this.getContentPane(); // Get the content pane of the JFrame
