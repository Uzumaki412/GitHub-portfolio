 ...
 *         REVISION:changed to using the table column index numbers instead of their column names in the processing loop.
...
public class Driver_1A
{
    ...
    try
    {
    	...
    	//REVISION HERE: changed to column index numbers from column names
    	while(myRslt.next() )
    	{
