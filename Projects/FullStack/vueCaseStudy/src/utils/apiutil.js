//const serverURL = "https://localhost:7211/api/";
// const serverURL = "/api/"; // relative path
const serverURL = (window.location.hostname === "localhost") ? "https://localhost:7211/api/" : "/api/";
